/*****************************************************************************
* Filename:          /home/javier/proyectos/master/master-dss/final/drivers/axi_sha256_sl_v1_00_a/src/axi_sha256_sl_selftest.c
* Version:           1.00.a
...
XStatus AXI_SHA256_SL_SelfTest(void * baseaddr_p)
{
  ...
  for (write_loop_index = 0 ; write_loop_index < TEST_AXI_LITE_USER_NUM_REG; write_loop_index++)
    AXI_SHA256_SL_mWriteSlaveReg0 (baseaddr, write_loop_index*4, (write_loop_index+1)*READ_WRITE_MUL_FACTOR);
  for (read_loop_index = 0 ; read_loop_index < TEST_AXI_LITE_USER_NUM_REG; read_loop_index++)
    if ( AXI_SHA256_SL_mReadSlaveReg0 (baseaddr, read_loop_index*4) != (read_loop_index+1)*READ_WRITE_MUL_FACTOR){
  ...
  if ( (AXI_SHA256_SL_mReadSlaveReg0 (baseaddr, 0)) != 0x0){
